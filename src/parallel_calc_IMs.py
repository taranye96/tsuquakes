...
# Local Imports
sys.path.insert(0, '/Users/tnye/tsuquakes/code/')
...
sys.path.insert(0, '/Users/tnye/kappa/code/github_code/processing/') # location of src 
...
# project_list = np.array([['final_runs_m7.8','sd0.1'],
#                           ['final_runs_m7.8','sd0.5'],
#                           ['final_runs_m7.8','sd1.0'],
#                           ['final_runs_m7.8','sd1.5'],
#                           ['final_runs_m7.8','sd2.0'],
#                           ['final_runs_m7.8','sd3.0'],
#                           ['final_runs_m7.8','standard']
#                         ])

# project_list = np.array([['ideal_runs_m7.8','rt1.2_sf0.41_sd1.0'],
#                           ['ideal_runs_m7.8','rt1.2_sf0.41_sd2.0'],
#                           ['ideal_runs_m7.8','rt1.422_sf0.395_sd1.581'],
#                           ['ideal_runs_m7.8','rt1.742_sf0.422_sd1.581'],
#                           ['ideal_runs_m7.8','rt2.0_sf0.42_sd1.0'],
#                           ['ideal_runs_m7.8','rt2.0_sf0.42_sd2.0']
#                           ])

# project_list = np.array([
#                           ['ideal_runs_m7.8','rt1.2_sf0.41_sd1.0'],
#                           ['ideal_runs_m7.8','rt1.2_sf0.41_sd2.0'],
#                           ['ideal_runs_m7.8','rt2.0_sf0.42_sd1.0'],
#                           ['ideal_runs_m7.8','rt2.0_sf0.42_sd2.0']
#                           ])
...
# project_list = np.array([['n_modes_test','72']])
...
# project_list = np.array([
#                           ['soft_velmod_test','soft1'],
#                           ['soft_velmod_test','soft2'],
#                           ['soft_velmod_test','soft3'],
#                           ['soft_velmod_test','soft4'],
#                           ['soft_velmod_test','soft5']
#                           ])
        ...
        for data in data_types:
            ...
            if data == 'gnss':
                ...
                dataset_dict = {'eventname':eventnames,'country':countries, 'origintime':origintimes,
                                ...
                                'Spectra_Disp_Bin1_E':syn_spec[:,0],'Spectra_Disp_Bin2_E':syn_spec[:,1],
                                'Spectra_Disp_Bin3_E':syn_spec[:,2],'Spectra_Disp_Bin4_E':syn_spec[:,3],
                                'Spectra_Disp_Bin5_E':syn_spec[:,4],'Spectra_Disp_Bin6_E':syn_spec[:,5],
                                'Spectra_Disp_Bin7_E':syn_spec[:,6],'Spectra_Disp_Bin8_E':syn_spec[:,7],
                                'Spectra_Disp_Bin9_E':syn_spec[:,8],'Spectra_Disp_Bin10_E':syn_spec[:,9]}
                ...
                dataset_dict = {'eventname':eventnames,'country':countries, 'origintime':origintimes,
                                ...
                                'Spectra_Acc_Bin1':syn_spec[:,0],'Spectra_Acc_Bin2':syn_spec[:,1],
                                'Spectra_Acc_Bin3':syn_spec[:,2],'Spectra_Acc_Bin4':syn_spec[:,3],
                                'Spectra_Acc_Bin5':syn_spec[:,4],'Spectra_Acc_Bin6':syn_spec[:,5],
                                'Spectra_Acc_Bin7':syn_spec[:,6],'Spectra_Acc_Bin8':syn_spec[:,7],
                                'Spectra_Acc_Bin9':syn_spec[:,8],'Spectra_Acc_Bin10':syn_spec[:,9]}
