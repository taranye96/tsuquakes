...
for rupture in rupture_list:
    ...
    # Calculate residuals
    pgd_res,pga_res,pgv_res,tPGD_orig_res,tPGD_parriv_res,spectra_res = res.calc_res(parameter,project,run)
...
## Save to file:
res_df.to_csv(f'/Users/tnye/FakeQuakes/{parameter}/{project}/flatfiles/residuals/{project}_res.csv',index=False)
