...
for file in disp_files:
    ...
    ax.loglog(freq,amp,c=u'#1f77b4',alpha=0.5)
...
disp = Line2D([0],[0], color=u'#1f77b4')
ax.legend([acc, disp],
          ['Strong Motion Acceleration','GNSS Displacement'])

plt.subplots_adjust(bottom=0.125,right=0.97,top=0.97)
plt.savefig('/Users/tnye/tsuquakes/manuscript/figures/FigS7_ringing-FAS.png',dpi=300)
