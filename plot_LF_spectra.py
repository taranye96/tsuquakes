...
plt.savefig('/Users/tnye/tsuquakes/plots/lf_tests/CGJI.LYE_waveforms.png', dpi=300)
plt.close()
...
plt.savefig('/Users/tnye/tsuquakes/plots/lf_tests/CGJI.LYE_spectra.png', dpi=300)
plt.close()
