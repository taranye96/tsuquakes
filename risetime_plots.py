...
# path to file
rupt1_path = '/Users/tnye/FakeQuakes/parameters/rise_time/rt1x/disp/output/ruptures/rt1x.000000.rupt'
...
plt.title('Rise time distribution for rt1x.000000')
...
# path to file
rupt2_path = '/Users/tnye/FakeQuakes/parameters/rise_time/rt1x/disp/output/ruptures/rt1x.000001.rupt'
...
plt.xlabel('rise time (s)')
plt.ylabel('# of subfaults')
plt.title('Rise time distribution for rt1x.000001')

# save fig
plt.savefig('/Users/tnye/tsuquakes/plots/risetime_dist/rt1x.000001.hist.png', dpi=300)
plt.close()

#%% Third .rupt file

# path to file
rupt3_path = '/Users/tnye/FakeQuakes/parameters/rise_time/rt1x/disp/output/ruptures/rt1x.000002.rupt'
...
plt.xlabel('rise time (s)')
plt.ylabel('# of subfaults')
plt.title('Rise time distribution for rt1x.000002')

# save fig
plt.savefig('/Users/tnye/tsuquakes/plots/risetime_dist/rt1x.000002.hist.png', dpi=300)
plt.close()