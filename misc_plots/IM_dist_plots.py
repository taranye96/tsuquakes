...
###############################################################################
# Script that makes comparison plots between IMs (PGA, PGV, PGD) and
...
# GNSS files directory 
gnss_dir = '/Users/tnye/tsuquakes/data/Mentawai2010/disp'
...
# Get gnss data
gnss_files = np.array(sorted((glob(gnss_dir + '/*'))))
