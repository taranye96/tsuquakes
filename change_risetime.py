...
###############################################################################
# Script that multiplies the rise time of the .rupt files generated by
# FakeQuakes by some multiplication factor. It also stores the original
# .rupt files in another folder. This script is used when varying rise time and
# should be run after generating the ruptures and before calculating the
# Green's functions. 
###############################################################################
